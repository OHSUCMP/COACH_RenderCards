...
public class RecommendationGenerator {
    ...
    public RecommendationGenerator(String filename, String targetRec) {
...
//        System.out.println(html);
    ...
    private int findRowNum(XSSFSheet sheet, String targetRec) throws Exception {
    ...
    private void writeRecHtml(Row rowFound, Row rowNext) {
        Cell cellRecFound = rowFound.getCell(colF);
    ...
    private void writeLinksHtml(String links, String linkLabels) {
    ...
    private void writeActionsHtml(Row rowFound, Row rowNext) {
    ...
    private void actionsHelper(String action, String type, String label) {
    ...
    private void writeCounselingHtml(String action, String label) {
    ...
    private void writeSuggestionLinksHtml(String action, String label) {
        html += "</td><td>\n";
        if (action.contains("label") && action.contains("url")) {
            String[] found = findUrlLabel(action);
            String actionLabel = found[0];
    ...
    private void writeGoalsHtml(String action, String label) {
        html += "</td><td>\n";
    ...
    private String[] findUrlLabel(String action) {
